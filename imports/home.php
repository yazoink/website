<h1>Welcome...</h1>
<p>I'm a 19 year old artist, compsci enthusiast and music enjoyer from Australia and I made this website to share my projects and talk about my interests. Click <a href='<?php echo $baseUrl; ?>/about'>here</a> to read more about me.</p>
<br>
<p>I also host some libre alternatives to popular websites, 
  you can read more about that <a href='<?php echo $baseUrl; ?>/services'>here</a>.</p>
<br>
...
<p>I use NixOS (btw). You can read a full overview <a href="<?php echo $baseUrl; ?>/technology">here</a>.</p>
<br>
