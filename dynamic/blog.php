...
if (array_key_exists('entry', $_GET)) { # if blog post specified
  echo "<p>
    <a href='index.php?nav=Blog'>&#11184; <b>Back</b></a> | <a href='index.php?nav=Blog&entry=" . $_GET['entry'] . "' onclick='copyURL()' id='copy-url'><b>&#x2398; Copy URL</b></a> | <a href='rss.php'><b><img src='images/rss.webp' width='12px'></img> RSS</b></a>
  </p>";
  echo "<br />";
  $found = false;
